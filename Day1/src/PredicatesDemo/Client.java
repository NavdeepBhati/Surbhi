...
public class Client {
	...
	public static void main(String[] args) {
        ...
        System.out.println("Negate: "+EmployeePredicate.filterEmployees(employees, EmployeePredicate.isAdultMale().negate()));

        System.out.println(EmployeePredicate.filterEmployees(employees, EmployeePredicate.isAdultFemale()));
        System.out.println(EmployeePredicate.filterEmployees(employees, EmployeePredicate.isAgeMoreThan(30)));
